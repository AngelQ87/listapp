        ...
        <ImageBackground style={styles.container} source={require('./images/fondo.png')}
            ...
            <View style={styles.inner}>
                <TouchableHighlight onPress={this.button_inicio}>
                    ...
                    borderWidth: 1}}>
                        <Text style={{color: 'white'}}>Crear usuario con Facebook</Text>
                    </View>
                </TouchableHighlight>
                <TouchableHighlight onPress={this.button_inicio}>
                    <View style={{ width: 300, height: 50, backgroundColor: 'white', marginTop: 60, 
                    marginBottom: 10, alignItems: 'center',justifyContent: 'center', borderRadius: 8,
                    borderWidth: 1}}>
                        <Text style={{color: 'black'}}>Crear usuario con Google</Text>
                    </View>
                </TouchableHighlight>
                <TouchableHighlight onPress={this.button_inicio} >
                    <View style={{ width: 300, height: 50, backgroundColor: 'red', marginTop: 60, 
                    marginBottom: 10, alignItems: 'center',justifyContent: 'center', borderRadius: 8,
                    borderWidth: 1}}>
                        <Text style={{color: 'white'}}>Crear usuario y contraseña</Text>
                    </View>
                </TouchableHighlight>
            </View>
        </ImageBackground>
